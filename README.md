...
### After downloading , open the Arduino IDE. Go to **Tools -> Boards -> Boards Manager**. In Boards Manager search for **Arduino AVR Boards**. Download the latest version of Arduino AVR Boards(I used 1.8.6).
